...
const ROUTE_MAP: Record<string, { method: string; path: string; type: 'query' | 'mutation' }> = {
  ...
  'analytics.retentionComparison':{ method: 'GET',  path: '/api/data/analytics/retention-comparison',     type: 'query' },
  'analytics.paymentFunnel':      { method: 'GET',  path: '/api/data/analytics/payment-funnel',           type: 'query' },
  'analytics.userFunnelStage':    { method: 'GET',  path: '/api/data/analytics/lifecycle-stages',         type: 'query' },
  'analytics.sendPaymentAlert':   { method: 'POST', path: '/api/data/analytics/detect-anomalies',         type: 'mutation' },
  'analytics.paymentAlerts':      { method: 'GET',  path: '/api/data/analytics/detect-anomalies',         type: 'query' },
  'analytics.levelInsights':      { method: 'GET',  path: '/api/data/analytics/level-insights',           type: 'query' },
  'analytics.productInsights':    { method: 'GET',  path: '/api/data/analytics/product-insights',         type: 'query' },
  'analytics.kpiDrillDown':       { method: 'GET',  path: '/api/data/analytics/kpi-drill-down',           type: 'query' },

  // ── Acquisition ────────────────────────────────────────────────────────
  'acquisition.listChannels':     { method: 'GET',  path: '/api/data/acquisition',                        type: 'query' },
  'acquisition.createChannel':    { method: 'POST', path: '/api/data/acquisition/channels',               type: 'mutation' },
  'acquisition.deleteChannel':    { method: 'DELETE',path:'/api/data/acquisition/channels',               type: 'mutation' },
  'acquisition.createCost':       { method: 'POST', path: '/api/data/acquisition/costs',                  type: 'mutation' },
  'acquisition.getROI':           { method: 'GET',  path: '/api/data/acquisition/roi',                    type: 'query' },
  'acquisition.getCostSummary':   { method: 'GET',  path: '/api/data/acquisition/roi',                    type: 'query' },
  ...
  'costProfit.listEntries':       { method: 'GET',  path: '/api/data/cost-profit/entries',                type: 'query' },
  'costProfit.createEntry':       { method: 'POST', path: '/api/data/cost-profit/entries',                type: 'mutation' },
  'costProfit.deleteEntry':       { method: 'DELETE',path:'/api/data/cost-profit/entries',                type: 'mutation' },
  'costProfit.getCostBreakdown':  { method: 'GET',  path: '/api/data/cost-profit/cost-breakdown',         type: 'query' },
  'costProfit.getProfitAnalysis': { method: 'GET',  path: '/api/data/cost-profit/profit-analysis',        type: 'query' },
  'costProfit.getProfitTrend':    { method: 'GET',  path: '/api/data/cost-profit/profit-trend',           type: 'query' },
  ...
  'experiments.create':           { method: 'POST', path: '/api/game/experiments',                        type: 'mutation' },
  'experiments.getById':          { method: 'GET',  path: '/api/game/experiments',                        type: 'query' },
  'experiments.getAnalysis':      { method: 'GET',  path: '/api/game/experiments',                        type: 'query' },
  'experiments.createVariant':    { method: 'POST', path: '/api/game/experiments',                        type: 'mutation' },
  'experiments.transition':       { method: 'POST', path: '/api/game/experiments',                        type: 'mutation' },
  'experiments.graduate':         { method: 'POST', path: '/api/game/experiments',                        type: 'mutation' },
  'experiments.checkGraduation':  { method: 'GET',  path: '/api/game/experiments',                        type: 'query' },
  'experiments.checkAllRunning':  { method: 'GET',  path: '/api/game/experiments/check-all-running',      type: 'query' },

  // ── Levels ────────────────────────────────────────────────────────────
  'levels.list':                  { method: 'GET',  path: '/api/game/levels',                             type: 'query' },
  'levels.create':                { method: 'POST', path: '/api/game/levels',                             type: 'mutation' },
  'levels.delete':                { method: 'DELETE',path:'/api/game/levels',                             type: 'mutation' },
  'levels.listProbes':            { method: 'GET',  path: '/api/game/levels/probes',                      type: 'query' },
  'levels.createProbe':           { method: 'POST', path: '/api/game/levels/probes',                      type: 'mutation' },
  'levels.updateProbe':           { method: 'PUT',  path: '/api/game/levels/probes',                      type: 'mutation' },
  'levels.listTemplates':         { method: 'GET',  path: '/api/game/levels/templates',                   type: 'query' },
  'levels.createTemplate':        { method: 'POST', path: '/api/game/levels/templates',                   type: 'mutation' },
  'levels.updateTemplate':        { method: 'PUT',  path: '/api/game/levels/templates',                   type: 'mutation' },
  'levels.analytics':             { method: 'GET',  path: '/api/game/levels/analytics',                   type: 'query' },
  'levels.difficultyDistribution':{ method: 'GET',  path: '/api/game/levels/difficulty-distribution',     type: 'query' },
  ...
  'segmentConfig.listBehaviorStrategies':{ method:'GET',  path: '/api/game/segment-config/list-behavior-strategies',type:'query' },
  'segmentConfig.updateBehaviorStrategy':{ method:'PUT',  path: '/api/game/segment-config/update-behavior-strategy',type:'mutation' },
  'segmentConfig.listTemplates':        { method: 'GET',  path: '/api/game/segment-config/list-templates',         type: 'query' },
  'segmentConfig.saveCurrentAsTemplate':{ method: 'POST', path: '/api/game/segment-config/save-current-as-template',type:'mutation' },
  'segmentConfig.applyTemplate':        { method: 'POST', path: '/api/game/segment-config/apply-template',         type: 'mutation' },
  'segmentConfig.deleteTemplate':       { method: 'DELETE',path:'/api/game/segment-config/delete-template',        type: 'mutation' },
  'segmentConfig.getSegmentDistribution':{ method:'GET',  path: '/api/game/segment-config/get-segment-distribution',type:'query' },
  'segmentTools.simulate':        { method: 'POST', path: '/api/game/segments/tools/simulate',            type: 'mutation' },
  'segmentTools.exportExcel':     { method: 'POST', path: '/api/game/segments/tools/export-excel',        type: 'mutation' },
  'segmentTools.importPreview':   { method: 'POST', path: '/api/game/segments/tools/import-preview',      type: 'mutation' },
  'segmentTools.importApply':     { method: 'POST', path: '/api/game/segments/tools/import-apply',        type: 'mutation' },

  // ── Audience ──────────────────────────────────────────────────────────
  'audience.list':                { method: 'GET',  path: '/api/ops/audience',                            type: 'query' },
  'audience.create':              { method: 'POST', path: '/api/ops/audience',                            type: 'mutation' },
  'audience.update':              { method: 'PUT',  path: '/api/ops/audience',                            type: 'mutation' },
  'audience.delete':              { method: 'DELETE',path:'/api/ops/audience',                            type: 'mutation' },
  'audience.preview':             { method: 'POST', path: '/api/ops/audience/preview',                    type: 'mutation' },
  'audience.calculateCount':      { method: 'POST', path: '/api/ops/audience',                            type: 'mutation' },
  'audience.getFieldRegistry':    { method: 'GET',  path: '/api/ops/audience/field-registry',             type: 'query' },
  'audience.getOperators':        { method: 'GET',  path: '/api/ops/audience/operators',                  type: 'query' },
  'audienceTemplates.list':       { method: 'GET',  path: '/api/ops/audience/templates',                  type: 'query' },
  'audienceTemplates.categories': { method: 'GET',  path: '/api/ops/audience/templates/categories',       type: 'query' },
  'audienceTemplates.createAudience':{ method:'POST',path:'/api/ops/audience/templates',                  type: 'mutation' },
  'audienceTemplates.previewCount':{ method: 'POST', path: '/api/ops/audience/templates',                 type: 'mutation' },

  // ── Monetize ──────────────────────────────────────────────────────────
  'monetize.listRules':           { method: 'GET',  path: '/api/game/monetize/rules',                     type: 'query' },
  'monetize.createRule':          { method: 'POST', path: '/api/game/monetize/rules',                     type: 'mutation' },
  'monetize.deleteRule':          { method: 'DELETE',path:'/api/game/monetize/rules',                     type: 'mutation' },
  'monetize.listTemplates':       { method: 'GET',  path: '/api/game/monetize/popup-templates',           type: 'query' },
  'monetize.createTemplate':      { method: 'POST', path: '/api/game/monetize/popup-templates',           type: 'mutation' },
  'monetize.updateRule':          { method: 'PUT',  path: '/api/game/monetize/rules',                     type: 'mutation' },

  // ── IAP Products ──────────────────────────────────────────────────────
  'iapProducts.list':             { method: 'GET',  path: '/api/game/monetize/iap-products',              type: 'query' },
  'iapProducts.stats':            { method: 'GET',  path: '/api/game/monetize/iap-products/stats',        type: 'query' },
  'iapProducts.create':           { method: 'POST', path: '/api/game/monetize/iap-products',              type: 'mutation' },
  'iapProducts.update':           { method: 'PUT',  path: '/api/game/monetize/iap-products',              type: 'mutation' },
  'iapProducts.delete':           { method: 'DELETE',path:'/api/game/monetize/iap-products',              type: 'mutation' },

  // ── Pricing Engine ────────────────────────────────────────────────────
  'pricingEngine.listStrategies':      { method: 'GET',  path: '/api/game/pricing/strategies',            type: 'query' },
  'pricingEngine.listRecommendations': { method: 'GET',  path: '/api/game/pricing/recommendations',       type: 'query' },
  'pricingEngine.getRevenueBaseline':  { method: 'GET',  path: '/api/game/pricing/revenue-baseline',      type: 'query' },
  'pricingEngine.getPaymentDistribution':{ method:'GET', path: '/api/game/pricing/payment-distribution',  type: 'query' },
  'pricingEngine.getLayerFeatures':    { method: 'GET',  path: '/api/game/pricing/layer-features',        type: 'query' },
  'pricingEngine.simulatePricing':     { method: 'POST', path: '/api/game/pricing/simulate',              type: 'mutation' },
  'pricingEngine.generatePricingAdvice':{ method:'POST', path: '/api/game/pricing/generate-advice',       type: 'mutation' },
  'pricingEngine.updateStrategyStatus':{ method: 'PUT',  path: '/api/game/pricing/recommendations',       type: 'mutation' },

  // ── Push Center ───────────────────────────────────────────────────────
  'pushCenter.list':              { method: 'GET',  path: '/api/ops/push/tasks',                          type: 'query' },
  'pushCenter.create':            { method: 'POST', path: '/api/ops/push/tasks',                          type: 'mutation' },
  'pushCenter.delete':            { method: 'DELETE',path:'/api/ops/push/tasks',                          type: 'mutation' },
  'pushCenter.send':              { method: 'POST', path: '/api/ops/push/tasks',                          type: 'mutation' },
  'pushCenter.stats':             { method: 'GET',  path: '/api/ops/push/stats',                          type: 'query' },
  'pushTemplates.list':           { method: 'GET',  path: '/api/ops/push/templates',                      type: 'query' },
  'pushTemplates.categories':     { method: 'GET',  path: '/api/ops/push/templates/categories',           type: 'query' },
  'pushTemplates.create':         { method: 'POST', path: '/api/ops/push/templates',                      type: 'mutation' },
  'pushTemplates.update':         { method: 'PUT',  path: '/api/ops/push/templates',                      type: 'mutation' },
  'pushTemplates.delete':         { method: 'DELETE',path:'/api/ops/push/templates',                      type: 'mutation' },
  'pushTemplates.useTemplate':    { method: 'POST', path: '/api/ops/push/templates',                      type: 'mutation' },

  // ── Recall Plans ──────────────────────────────────────────────────────
  'recallPlans.list':             { method: 'GET',  path: '/api/ops/recall',                              type: 'query' },
  'recallPlans.stats':            { method: 'GET',  path: '/api/ops/recall/stats',                        type: 'query' },
  'recallPlans.create':           { method: 'POST', path: '/api/ops/recall',                              type: 'mutation' },
  'recallPlans.update':           { method: 'PUT',  path: '/api/ops/recall',                              type: 'mutation' },
  'recallPlans.delete':           { method: 'DELETE',path:'/api/ops/recall',                              type: 'mutation' },
  ...
  // ── Scheduler ─────────────────────────────────────────────────────────
  'scheduler.list':               { method: 'GET',  path: '/api/ops/scheduler/tasks',                     type: 'query' },
  'scheduler.stats':              { method: 'GET',  path: '/api/ops/scheduler/stats',                     type: 'query' },
  'scheduler.create':             { method: 'POST', path: '/api/ops/scheduler/tasks',                     type: 'mutation' },
  'scheduler.update':             { method: 'PUT',  path: '/api/ops/scheduler/tasks',                     type: 'mutation' },
  'scheduler.delete':             { method: 'DELETE',path:'/api/ops/scheduler/tasks',                     type: 'mutation' },
  'scheduler.toggle':             { method: 'POST', path: '/api/ops/scheduler/tasks',                     type: 'mutation' },
  'scheduler.trigger':            { method: 'POST', path: '/api/ops/scheduler/tasks',                     type: 'mutation' },
  'scheduler.logs':               { method: 'GET',  path: '/api/ops/scheduler/logs',                      type: 'query' },
  'scheduler.cleanupLogs':        { method: 'DELETE',path:'/api/ops/scheduler/logs/cleanup',              type: 'mutation' },
  'scheduler.getTaskTypes':       { method: 'GET',  path: '/api/ops/scheduler/task-types',                type: 'query' },
  'scheduler.seedBuiltInTasks':   { method: 'POST', path: '/api/ops/scheduler/seed-builtin',              type: 'mutation' },

  // ── Daily Report ──────────────────────────────────────────────────────
  'dailyReport.list':             { method: 'GET',  path: '/api/ops/daily-report',                        type: 'query' },
  'dailyReport.generate':         { method: 'POST', path: '/api/ops/daily-report/generate',               type: 'mutation' },
  'dailyReport.sendNotification': { method: 'POST', path: '/api/ops/daily-report',                        type: 'mutation' },

  // ── Feishu ────────────────────────────────────────────────────────────
  'feishu.loginWithCode':         { method: 'GET',  path: '/api/auth/feishu/callback',                    type: 'mutation' },
  'feishu.listUsers':             { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.listRoles':             { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.createRole':            { method: 'POST', path: '/api/ops/feishu',                              type: 'mutation' },
  'feishu.deleteRole':            { method: 'DELETE',path:'/api/ops/feishu',                              type: 'mutation' },
  'feishu.updateRole':            { method: 'PUT',  path: '/api/ops/feishu',                              type: 'mutation' },
  'feishu.listDepartments':       { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.getDepartmentTree':     { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.syncContacts':          { method: 'POST', path: '/api/ops/feishu',                              type: 'mutation' },
  'feishu.listMenuPermissions':   { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.getUserRoles':          { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.setUserRoles':          { method: 'POST', path: '/api/ops/feishu',                              type: 'mutation' },
  'feishu.getRolePermissions':    { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },
  'feishu.setRolePermissions':    { method: 'POST', path: '/api/ops/feishu',                              type: 'mutation' },
  'feishu.myPermissions':         { method: 'GET',  path: '/api/ops/feishu',                              type: 'query' },

  // ── Feishu Notification ───────────────────────────────────────────────
  'feishuNotification.listConfigs':   { method: 'GET',  path: '/api/ops/feishu/configs',                  type: 'query' },
  'feishuNotification.createConfig':  { method: 'POST', path: '/api/ops/feishu/configs',                  type: 'mutation' },
  'feishuNotification.updateConfig':  { method: 'PUT',  path: '/api/ops/feishu/configs',                  type: 'mutation' },
  'feishuNotification.deleteConfig':  { method: 'DELETE',path:'/api/ops/feishu/configs',                  type: 'mutation' },
  'feishuNotification.getEventTypes': { method: 'GET',  path: '/api/ops/feishu/event-types',              type: 'query' },
  'feishuNotification.getStats':      { method: 'GET',  path: '/api/ops/feishu/stats',                    type: 'query' },
  'feishuNotification.listLogs':      { method: 'GET',  path: '/api/ops/feishu/logs',                     type: 'query' },
  'feishuNotification.testWebhook':   { method: 'POST', path: '/api/ops/feishu/test-webhook',             type: 'mutation' },
  'feishuNotification.sendTestAlert': { method: 'POST', path: '/api/ops/feishu/send-alert',               type: 'mutation' },
  'feishuNotification.sendTestText':  { method: 'POST', path: '/api/ops/feishu/send-text',                type: 'mutation' },

  // ── Game Projects ─────────────────────────────────────────────────────
  'gameProjects.list':            { method: 'GET',  path: '/api/game/projects',                           type: 'query' },
  'gameProjects.create':          { method: 'POST', path: '/api/game/projects',                           type: 'mutation' },
  'gameProjects.delete':          { method: 'DELETE',path:'/api/game/projects',                           type: 'mutation' },
  'gameProjects.regenerateKeys':  { method: 'POST', path: '/api/game/projects',                           type: 'mutation' },
  'gameProjects.accessLogs':      { method: 'GET',  path: '/api/game/projects',                           type: 'query' },
  'gameProjects.accessStats':     { method: 'GET',  path: '/api/game/projects',                           type: 'query' },
  'gameServiceConfigs.list':      { method: 'GET',  path: '/api/game/service-configs',                    type: 'query' },
  'gameServiceConfigs.create':    { method: 'POST', path: '/api/game/service-configs',                    type: 'mutation' },
  'gameServiceConfigs.update':    { method: 'PUT',  path: '/api/game/service-configs',                    type: 'mutation' },
  'gameServiceConfigs.delete':    { method: 'DELETE',path:'/api/game/service-configs',                    type: 'mutation' },
  'gameServiceConfigs.getById':   { method: 'GET',  path: '/api/game/service-configs',                    type: 'query' },
  'gameServiceConfigs.serviceTypes':{ method:'GET', path: '/api/game/service-configs/service-types',      type: 'query' },
  'gameServiceConfigs.verify':    { method: 'POST', path: '/api/game/service-configs',                    type: 'mutation' },

  // ── Config ─────────────────────────────────────────────────────────────
  'config.listItems':             { method: 'GET',  path: '/api/game/configs/items',                      type: 'query' },
  'config.createItem':            { method: 'POST', path: '/api/game/configs/items',                      type: 'mutation' },
  'config.listRegionGroups':      { method: 'GET',  path: '/api/game/configs/region-groups',              type: 'query' },
  'config.createRegionGroup':     { method: 'POST', path: '/api/game/configs/region-groups',              type: 'mutation' },
  'config.listCountries':         { method: 'GET',  path: '/api/game/configs/countries',                  type: 'query' },

  // ── Config Versions ───────────────────────────────────────────────────
  'configVersions.list':          { method: 'GET',  path: '/api/game/configs/versions',                   type: 'query' },
  'configVersions.createSnapshot':{ method: 'POST', path: '/api/game/configs/versions',                   type: 'mutation' },
  'configVersions.compare':       { method: 'GET',  path: '/api/game/configs/versions/compare',           type: 'query' },
  'configVersions.publish':       { method: 'POST', path: '/api/game/configs/versions',                   type: 'mutation' },
  'configRollback.listTriggers':  { method: 'GET',  path: '/api/game/configs/versions',                   type: 'query' },
  'configRollback.createTrigger': { method: 'POST', path: '/api/game/configs/versions',                   type: 'mutation' },
  'configRollback.updateTrigger': { method: 'PUT',  path: '/api/game/configs/versions',                   type: 'mutation' },
  'configRollback.deleteTrigger': { method: 'DELETE',path:'/api/game/configs/versions',                   type: 'mutation' },
  'configRollback.rollbackWithAudit':{ method:'POST',path:'/api/game/configs/versions',                   type: 'mutation' },
  'configRollback.listAuditLogs': { method: 'GET',  path: '/api/game/configs/versions',                   type: 'query' },

  // ── User Profiles ─────────────────────────────────────────────────────
  'userProfiles.listGameUsers':   { method: 'GET',  path: '/api/ai/user-profiles',                        type: 'query' },
  'userProfiles.getProfile':      { method: 'GET',  path: '/api/ai/user-profiles',                        type: 'query' },
  'userProfiles.getPaymentRecords':{ method:'GET',  path: '/api/ai/user-profiles',                        type: 'query' },
  'userProfiles.getPaymentSummary':{ method:'GET',  path: '/api/ai/user-profiles',                        type: 'query' },
  'userProfiles.getPaymentTrend': { method: 'GET',  path: '/api/ai/user-profiles',                        type: 'query' },
  'userProfiles.getSegmentHistory':{ method:'GET',  path: '/api/ai/user-profiles',                        type: 'query' },

  // ── Knowledge Base ────────────────────────────────────────────────────
  'knowledgeBase.listKnowledge':  { method: 'GET',  path: '/api/ai/knowledge',                            type: 'query' },
  'knowledgeBase.createKnowledge':{ method: 'POST', path: '/api/ai/knowledge',                            type: 'mutation' },
  'knowledgeBase.updateKnowledge':{ method: 'PUT',  path: '/api/ai/knowledge',                            type: 'mutation' },
  'knowledgeBase.deleteKnowledge':{ method: 'DELETE',path:'/api/ai/knowledge',                            type: 'mutation' },
  'knowledgeBase.searchKnowledge':{ method: 'GET',  path: '/api/ai/knowledge/search',                     type: 'query' },

  // ── Decision Logs ─────────────────────────────────────────────────────
  'decisionLogs.list':            { method: 'GET',  path: '/api/ai/decisions',                            type: 'query' },
  'decisionLogs.stats':           { method: 'GET',  path: '/api/ai/decisions/stats',                      type: 'query' },
  'decisionLogs.updateAction':    { method: 'PUT',  path: '/api/ai/decisions',                            type: 'mutation' },
  'decisionLogs.updateEffect':    { method: 'PUT',  path: '/api/ai/decisions',                            type: 'mutation' },

  // ── Custom Reports ────────────────────────────────────────────────────
  'customReports.list':           { method: 'GET',  path: '/api/ai/reports',                              type: 'query' },
  'customReports.create':         { method: 'POST', path: '/api/ai/reports',                              type: 'mutation' },
  'customReports.delete':         { method: 'DELETE',path:'/api/ai/reports',                              type: 'mutation' },
  'customReports.execute':        { method: 'POST', path: '/api/ai/reports',                              type: 'mutation' },
  'customReports.adHocQuery':     { method: 'POST', path: '/api/ai/reports',                              type: 'mutation' },
  'customReports.schema':         { method: 'GET',  path: '/api/ai/reports',                              type: 'query' },

  // ── Export Center ─────────────────────────────────────────────────────
  'exportCenter.listDataSources': { method: 'GET',  path: '/api/ai/export/data-sources',                  type: 'query' },
  'exportCenter.listTasks':       { method: 'GET',  path: '/api/ai/export/tasks',                         type: 'query' },
  'exportCenter.createExport':    { method: 'POST', path: '/api/ai/export/tasks',                         type: 'mutation' },
  'exportCenter.listSchedules':   { method: 'GET',  path: '/api/ai/export/tasks',                         type: 'query' },
  'exportCenter.createSchedule':  { method: 'POST', path: '/api/ai/export/tasks',                         type: 'mutation' },
  'exportCenter.updateSchedule':  { method: 'PUT',  path: '/api/ai/export/tasks',                         type: 'mutation' },
  'exportCenter.deleteSchedule':  { method: 'DELETE',path:'/api/ai/export/tasks',                         type: 'mutation' },

  // ── Audit Log ─────────────────────────────────────────────────────────
  'auditLog.list':                { method: 'GET',  path: '/api/ai/audit',                                type: 'query' },
  'auditLog.stats':               { method: 'GET',  path: '/api/ai/audit/stats',                          type: 'query' },
  'logs.list':                    { method: 'GET',  path: '/api/ai/audit',                                type: 'query' },
  ...
  // ── Te Integration ────────────────────────────────────────────────────
  'teIntegration.listConnections':     { method: 'GET',  path: '/api/game/service-configs',               type: 'query' },
  'teIntegration.createConnection':    { method: 'POST', path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.deleteConnection':    { method: 'DELETE',path:'/api/game/service-configs',               type: 'mutation' },
  'teIntegration.activateConnection':  { method: 'POST', path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.testConnection':      { method: 'POST', path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.listSyncTasks':       { method: 'GET',  path: '/api/game/service-configs',               type: 'query' },
  'teIntegration.createSyncTask':      { method: 'POST', path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.getSyncLogs':         { method: 'GET',  path: '/api/game/service-configs',               type: 'query' },
  'teIntegration.listLinkageRules':    { method: 'GET',  path: '/api/game/service-configs',               type: 'query' },
  'teIntegration.createLinkageRule':   { method: 'POST', path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.deleteLinkageRule':   { method: 'DELETE',path:'/api/game/service-configs',               type: 'mutation' },
  'teIntegration.toggleLinkageRule':   { method: 'PUT',  path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.executeLinkageRule':  { method: 'POST', path: '/api/game/service-configs',               type: 'mutation' },
  'teIntegration.listLinkageExecutions':{ method:'GET',  path: '/api/game/service-configs',               type: 'query' },

  // ── Loop Engine ───────────────────────────────────────────────────────
  'loopEngine.enhancedDashboard':      { method: 'GET',  path: '/api/data/dashboard/overview',            type: 'query' },
  'loopEngine.listPredictiveLabels':   { method: 'GET',  path: '/api/ai/user-profiles',                   type: 'query' },
  'loopEngine.listBehaviorEvents':     { method: 'GET',  path: '/api/ai/user-profiles',                   type: 'query' },
  'loopEngine.listDecisionTraces':     { method: 'GET',  path: '/api/ai/decisions',                       type: 'query' },
  'loopEngine.decisionTraceStats':     { method: 'GET',  path: '/api/ai/decisions/stats',                 type: 'query' },
  'loopEngine.listDifficultyMappings': { method: 'GET',  path: '/api/game/levels',                        type: 'query' },
  'loopEngine.updateDifficultyMapping':{ method: 'PUT',  path: '/api/game/levels',                        type: 'mutation' },
  'loopEngine.listExperimentLinks':    { method: 'GET',  path: '/api/game/experiments',                   type: 'query' },
  'loopEngine.listLevelEvents':        { method: 'GET',  path: '/api/game/levels/analytics',              type: 'query' },
  'loopEngine.levelEventSummary':      { method: 'GET',  path: '/api/game/levels/analytics',              type: 'query' },
  'loopEngine.behaviorEventStats':     { method: 'GET',  path: '/api/data/analytics/product-insights',    type: 'query' },
  'loopEngine.labelDistribution':      { method: 'GET',  path: '/api/data/analytics/lifecycle-stages',    type: 'query' },
  'loopEngine.decisionFunnel':         { method: 'GET',  path: '/api/data/analytics/payment-funnel',      type: 'query' },
  'loopEngine.loopHealthTrend':        { method: 'GET',  path: '/api/data/analytics/retention-comparison',type: 'query' },

  // ── Reports (misc) ────────────────────────────────────────────────────
  'reports.adDailySummary':       { method: 'GET',  path: '/api/data/dashboard/overview',                 type: 'query' },
  'reports.monetizeDailySummary': { method: 'GET',  path: '/api/data/dashboard/overview',                 type: 'query' },
  'reports.retentionWeekly':      { method: 'GET',  path: '/api/data/analytics/cohort-retention',         type: 'query' },
  'reports.userQualityDaily':     { method: 'GET',  path: '/api/data/analytics/lifecycle-stages',         type: 'query' },

  // ── Alert Enhancement (stub) ──────────────────────────────────────────
  'alertEnhancement.listSilenceRules':    { method: 'GET',  path: '/api/ops/alerts/rules',                type: 'query' },
  'alertEnhancement.createSilenceRule':   { method: 'POST', path: '/api/ops/alerts/rules',                type: 'mutation' },
  'alertEnhancement.updateSilenceRule':   { method: 'PUT',  path: '/api/ops/alerts/update-rule',          type: 'mutation' },
  'alertEnhancement.deleteSilenceRule':   { method: 'DELETE',path:'/api/ops/alerts/delete-rule',          type: 'mutation' },
  'alertEnhancement.listEscalationRules': { method: 'GET',  path: '/api/ops/alerts/rules',                type: 'query' },
  'alertEnhancement.createEscalationRule':{ method: 'POST', path: '/api/ops/alerts/rules',                type: 'mutation' },
  'alertEnhancement.updateEscalationRule':{ method: 'PUT',  path: '/api/ops/alerts/update-rule',          type: 'mutation' },
  'alertEnhancement.deleteEscalationRule':{ method: 'DELETE',path:'/api/ops/alerts/delete-rule',          type: 'mutation' },
  'alertEnhancement.runEscalation':       { method: 'POST', path: '/api/ops/alerts/run-detection',        type: 'mutation' },
  'alertEnhancement.flushDigests':        { method: 'POST', path: '/api/ops/alerts/run-detection',        type: 'mutation' },
  'alertEnhancement.listAggregationRules':{ method: 'GET',  path: '/api/ops/alerts/rules',                type: 'query' },
  'alertEnhancement.createAggregationRule':{ method:'POST', path: '/api/ops/alerts/rules',                type: 'mutation' },
  'alertEnhancement.updateAggregationRule':{ method:'PUT',  path: '/api/ops/alerts/update-rule',          type: 'mutation' },
  'alertEnhancement.deleteAggregationRule':{ method:'DELETE',path:'/api/ops/alerts/delete-rule',          type: 'mutation' },
  'alertEnhancement.listMaskingRules':    { method: 'GET',  path: '/api/ops/alerts/rules',                type: 'query' },
  'alertEnhancement.createMaskingRule':   { method: 'POST', path: '/api/ops/alerts/rules',                type: 'mutation' },
  'alertEnhancement.updateMaskingRule':   { method: 'PUT',  path: '/api/ops/alerts/update-rule',          type: 'mutation' },
  'alertEnhancement.deleteMaskingRule':   { method: 'DELETE',path:'/api/ops/alerts/delete-rule',          type: 'mutation' },
  'alertEnhancement.previewMasking':      { method: 'GET',  path: '/api/ops/alerts/stats',                type: 'query' },

  // ── Auto Response Approval (stub) ─────────────────────────────────────
  'autoResponseApproval.listApprovals':      { method: 'GET',  path: '/api/ops/alerts',                   type: 'query' },
  'autoResponseApproval.getApprovalStats':   { method: 'GET',  path: '/api/ops/alerts/stats',             type: 'query' },
  'autoResponseApproval.review':             { method: 'PUT',  path: '/api/ops/alerts/acknowledge',       type: 'mutation' },
  'autoResponseApproval.listPolicies':       { method: 'GET',  path: '/api/ops/alerts/rules',             type: 'query' },
  'autoResponseApproval.createPolicy':       { method: 'POST', path: '/api/ops/alerts/rules',             type: 'mutation' },
  'autoResponseApproval.updateLevelConfig':  { method: 'PUT',  path: '/api/ops/alerts/update-rule',       type: 'mutation' },
  'autoResponseApproval.deletePolicy':       { method: 'DELETE',path:'/api/ops/alerts/delete-rule',       type: 'mutation' },
  'autoResponseApproval.listLevelConfigs':   { method: 'GET',  path: '/api/ops/alerts/rules',             type: 'query' },
  'autoResponseApproval.createLevelConfig':  { method: 'POST', path: '/api/ops/alerts/rules',             type: 'mutation' },
  'autoResponseApproval.deleteLevelConfig':  { method: 'DELETE',path:'/api/ops/alerts/delete-rule',       type: 'mutation' },
  'autoResponseApproval.listEffectTracking': { method: 'GET',  path: '/api/ops/alerts/list-reports',      type: 'query' },
  'autoResponseApproval.getEffectTrackingStats':{ method:'GET',path:'/api/ops/alerts/stats',              type: 'query' },
  'autoResponseApproval.exportApprovals':    { method: 'POST', path: '/api/ai/export/tasks',              type: 'mutation' },
  'autoResponseApproval.exportSLAStats':     { method: 'POST', path: '/api/ai/export/tasks',              type: 'mutation' },
  'autoResponseApproval.notifyPendingApprovals':{ method:'POST',path:'/api/ops/feishu/send-alert',        type: 'mutation' },
  'autoResponseApproval.processTimeouts':    { method: 'POST', path: '/api/ops/alerts/run-detection',     type: 'mutation' },

  // ── AppsFlyer (stub → data-service) ──────────────────────────────────
  'appsflyer.getConfigStatus':    { method: 'GET',  path: '/api/game/service-configs/status',             type: 'query' },
  'appsflyer.getReportTypes':     { method: 'GET',  path: '/api/game/service-configs/service-types',      type: 'query' },
  'appsflyer.listSyncLogs':       { method: 'GET',  path: '/api/game/service-configs',                    type: 'query' },
  'appsflyer.syncInstalls':       { method: 'POST', path: '/api/game/service-configs',                    type: 'mutation' },
  'appsflyer.syncInAppEvents':    { method: 'POST', path: '/api/game/service-configs',                    type: 'mutation' },
  'appsflyer.syncAdRevenue':      { method: 'POST', path: '/api/game/service-configs',                    type: 'mutation' },
  'appsflyer.syncCosts':          { method: 'POST', path: '/api/game/service-configs',                    type: 'mutation' },

  // ── Ad Revenue (stub → data analytics) ───────────────────────────────
  'adRevenue.listNetworks':       { method: 'GET',  path: '/api/data/analytics/product-insights',         type: 'query' },
  'adRevenue.getRevenueSummary':  { method: 'GET',  path: '/api/data/dashboard/overview',                 type: 'query' },
  'adRevenue.getTotalRevenue':    { method: 'GET',  path: '/api/data/dashboard/revenue-timeline',         type: 'query' },
  'adRevenue.listPlacements':     { method: 'GET',  path: '/api/data/analytics/product-insights',         type: 'query' },
  'adRevenue.createNetwork':      { method: 'POST', path: '/api/data/acquisition/channels',               type: 'mutation' },
  'adRevenue.createPlacement':    { method: 'POST', path: '/api/data/acquisition/channels',               type: 'mutation' },
  'adRevenue.deleteNetwork':      { method: 'DELETE',path:'/api/data/acquisition/channels',               type: 'mutation' },

  // ── Event Analysis (stub → analytics) ────────────────────────────────
  'eventAnalysis.listEvents':     { method: 'GET',  path: '/api/data/analytics/product-insights',         type: 'query' },
  'eventAnalysis.stats':          { method: 'GET',  path: '/api/data/dashboard/stats',                    type: 'query' },
  'eventAnalysis.listConfigs':    { method: 'GET',  path: '/api/data/analytics/level-insights',           type: 'query' },
  'eventAnalysis.createEvent':    { method: 'POST', path: '/api/data/acquisition/channels',               type: 'mutation' },
  'eventAnalysis.createConfig':   { method: 'POST', path: '/api/data/acquisition/channels',               type: 'mutation' },
  'eventAnalysis.deleteEvent':    { method: 'DELETE',path:'/api/data/acquisition/channels',               type: 'mutation' },
  'eventAnalysis.deleteConfig':   { method: 'DELETE',path:'/api/data/acquisition/channels',               type: 'mutation' },
  'eventAnalysis.executeAnalysis':{ method: 'POST', path: '/api/data/analytics/product-insights',         type: 'mutation' },
  'eventAnalysis.funnelAnalysis': { method: 'POST', path: '/api/data/analytics/payment-funnel',           type: 'mutation' },
  'eventAnalysis.retentionAnalysis':{ method:'POST',path: '/api/data/analytics/cohort-retention',         type: 'mutation' },

  // ── Comparison Analysis (stub → analytics) ────────────────────────────
  'comparison.versionComparison': { method: 'GET',  path: '/api/game/configs/versions/compare',           type: 'query' },
  'comparison.segmentComparison': { method: 'GET',  path: '/api/data/analytics/lifecycle-by-segment',     type: 'query' },
  'comparison.countryComparison': { method: 'GET',  path: '/api/ai/global-view/region-breakdown',         type: 'query' },
  'comparison.creativeComparison':{ method: 'GET',  path: '/api/data/acquisition/roi',                    type: 'query' },
  'comparison.listVersions':      { method: 'GET',  path: '/api/game/configs/versions',                   type: 'query' },

  // ── SDK Download (stub) ───────────────────────────────────────────────
  'sdkDownload.downloadPackage':  { method: 'GET',  path: '/api/game/service-configs',                    type: 'query' },

  // ── ApiDocs (stub) ────────────────────────────────────────────────────
  'apiDocs.getAll':               { method: 'GET',  path: '/api/game/service-configs/service-types',      type: 'query' },
  'router.procedure':             { method: 'GET',  path: '/api/data/dashboard/stats',                    type: 'query' },
  // 用户旅程
